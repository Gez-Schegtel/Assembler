...
;
; Aclaración: Descubrí la función stosw, que es como lodsw pero sirve para copiar en DI el vector.
...
copiar_vector:
  lodsw            ; Carga [SI] en AX y suma 2 a SI automáticamente
  stosw            ; Guarda AX en [DI] y suma 2 a DI automáticamente
  loop copiar_vector

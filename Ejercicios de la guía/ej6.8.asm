...
xor cx, cx ; Limpiamos el registro por las dudas, porque si la parte tiene algo, el programa no funcionará bien. Recordá que el BYTE 1 es un número de 8 bits, y el registro CX que usa la función loop, de 16 bits.
mov cl, [buffer + 1] ; Guardamos en CX la cantidad de caracteres ingresador, para poder usarlo con la función loop.
...
mostrar_cadena:
  ...
  cmp cx, 1 ; Vemos si estamos en la última letra.
  je saltar_coma
